...
<html>
    <body>
        <div align="center">
            ...
            <i style="font-family:monospace;">Sender\'s email :&nbsp;</i>'.$_POST['mail'].'<br />

            <h1 style="font-family:monospace;"><u>Your idea :</u></h1>
            ...
            <h3 style="font-family:monospace;">What a good idea !</h3>
...
';
            ...
            mail($_POST['mail'], "Your idea - Eurêka", $message, $header);

            $succes="<div class='succes'>Your idea has been sent to you <br> You will be redirected</div>";

            header('refresh:2;url=index%20(english).php');

        }else{
            $erreur="<div class='erreur'>Please complete all fields</div>";
        }
    }
    ...
    if(isset($erreur)){
        echo $erreur;
            ...
            <form method="POST" action="">
                ...
                <h2 id="note">Your idea <i class='fas fa-arrow-down' style='font-size:16px'></i></h2>

                <input type="text" class="form" name="message" value="<?php if(isset($_POST['idea'])){ echo $_POST['idea']; }else{ echo $_POST['message']; } ?>" /><br><br>

                <h2 id="note">Send your idea by email <i class='fas fa-terminal' style='font-size:16px'></i></h2>

                <input type="email" class="form" name="mail" placeholder="Your email"/><br /><br />

                <input type="submit" value="Send" name="mailform" class="form"/><br /><br />
