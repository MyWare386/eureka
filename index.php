...
$fichier = file('francais.txt'); // Nom du fichier qui contient les citations
...
<html lang="fr">
    ...
    <body>
        ...
        <acronym title="Vous avez trouvé une idée ?">
            <h1 class="ml1">
                <p id="word">
        ...
        <button type="button" class="word" onclick="document.location.reload(false)">Un autre mot <i class='fas fa-redo' style='font-size:16px'></i></button>
        ...
        <div style='display:none;' id="form">
            ...
            <h2 id="note">Notez votre idée <i class='far fa-edit' style='font-size:16px'></i></h2>
            <h4 id="attention"><i class='fas fa-exclamation-triangle' style='font-size:12px;color:red'></i> Attention, si vous cliquez sur "Un autre mot", votre idée s'effacera <i class='fas fa-exclamation-triangle' style='font-size:12px;color:red'></i></h6>
            ...
            <form action="mail.php" method="post">
                ...
                <textarea class="form" name="idea" placeholder="Votre idée" cols="50" rows="15" id="tocopy"></textarea><br /><br /><br /><br />

                <input type="button" value="Copier votre idée dans le presse-papier" class="js-copy" data-target="#tocopy"><br /><br /><br /><br />

                <input type="submit" value="Envoyez-vous votre idée par mail" class="js-copy">
    ...
    <script>
        ...
        function docopy() {
            ...
            try {
                ...
                if (result) {
                    // La copie a réussi
                    alert('Votre idée a été copiée dans le presse-papier');
                }
            }
            catch(err) {
